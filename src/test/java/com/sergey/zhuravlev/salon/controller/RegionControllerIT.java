...
/**
 * Integration tests for the {@link RegionController} REST controller.
 */
...
public class RegionControllerIT {
    ...
    public void setup() {
        ...
        final RegionController regionController = new RegionController(regionService);
        this.restRegionMockMvc = MockMvcBuilders.standaloneSetup(regionController)
