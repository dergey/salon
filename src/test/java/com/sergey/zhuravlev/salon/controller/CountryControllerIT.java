...
/**
 * Integration tests for the {@link CountryController} REST controller.
 */
...
/*
    ...
    public void setup() {
        ...
        final CountryController countryController = new CountryController(countryService, regionService, countryMapper);
    ...
    public static CountryRequestDto createDto() {
        CountryRequestDto dto = new CountryRequestDto();
        dto.setCountryName(DEFAULT_COUNTRY_NAME);
        return dto;
    }

    public static CountryRequestDto createUpdatedDto() {
        CountryRequestDto dto = new CountryRequestDto();
        dto.setCountryName(UPDATED_COUNTRY_NAME);
        return dto;
    }

    @BeforeEach
    public void initTest() {
        countryDto = createDto();
    }
    ...
    public void getAllCountries() throws Exception {
        ...
        Country country = countryService.create(DEFAULT_COUNTRY_NAME, null);
    ...
    public void updateCountry() throws Exception {
        // Initialize the database
        countryService.create(DEFAULT_COUNTRY_NAME, null);

        int databaseSizeBeforeUpdate = countryRepository.findAll().size();

        // Update the country
        CountryRequestDto updatedCountry = createUpdatedDto();
