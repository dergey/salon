...
import com.sergey.zhuravlev.salon.repository.AuthorityRepository;
...
import com.sergey.zhuravlev.salon.web.rest.vm.KeyAndPasswordVM;
import com.sergey.zhuravlev.salon.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIT {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.langKey").value("ru"))
