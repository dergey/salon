...
import { getEntity, deleteEntity } from './material-in-salon.reducer';

export interface IMaterialInSalonDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class MaterialInSalonDeleteDialog extends React.Component<IMaterialInSalonDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.materialInSalonEntity.id);
